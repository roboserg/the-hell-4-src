...
Affix AffixesColiseum[] = {
	// Name,	Effects,	type,	minLow,	minHigh,	maxLow,	maxHigh,	chanceLow,	chanceHigh,	QualityLevel,	item,	IS_ALL,	ExcludedCombinations,	DoubleChance,	NotCursed,	MinGoldValue,	MaxGoldValue,	Multiplier, CLVL req min,	CLVL req max
		...
		{ 487,	"Palladium",AE_TO_HIT,	0,	0,	0,	0,	0,	101,	110,	 92,	IA_MELEE | IA_MALLET | IA_PISTOL,									IS_BATTLE,	16,	0,	1,	10'000,	11'000,	11,	 51,	 53 },
		...
		{ 496,	"Strange",	AE_TO_HIT,	0,	0,	0,	0,	0,	191,	200,	183,	IA_MELEE | IA_MALLET | IA_PISTOL,									IS_BATTLE,	16,	0,	1,	28'000,	29'000,	16,	100,	116 },
		...
		{  84,	"Leading",	AE_TO_HIT,	0,	0,	0,	0,	0,	66,	70,	170,	IA_JEWEL,	IS_BATTLE,	0,	0,	1,	56'000,	60'000,	9,	92,	97 },
		...
		{  19,	"Fierce",	AE_PERCENT_DAMAGE,	0,	 25,	 50,	0,	0,	0,	0,	  2,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	   100,	   200,	2,	0,	0 },
		{  20,	"Brutal",	AE_PERCENT_DAMAGE,	0,	 51,	 75,	0,	0,	0,	0,	  5,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	   357,	   525,	2,	2,	3 },
		{  21,	"Injuring",	AE_PERCENT_DAMAGE,	0,	 76,	100,	0,	0,	0,	0,	 10,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	   760,	 1'000,	3,	4,	5 },
		{  22,	"Furious",	AE_PERCENT_DAMAGE,	0,	101,	125,	0,	0,	0,	0,	 15,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 1'111,	 1'375,	3,	6,	7 },
		{  23,	"Vicious",	AE_PERCENT_DAMAGE,	0,	126,	150,	0,	0,	0,	0,	 20,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 1'512,	 1'800,	4,	8,	10 },
		{  24,	"Severe",	AE_PERCENT_DAMAGE,	0,	151,	175,	0,	0,	0,	0,	 25,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 1'963,	 2'275,	4,	12,	17 },
		{  25,	"Cruel",	AE_PERCENT_DAMAGE,	0,	176,	200,	0,	0,	0,	0,	 30,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 2'464,	 2'800,	5,	21,	24 },
		{  26,	"Sadistic",	AE_PERCENT_DAMAGE,	0,	201,	220,	0,	0,	0,	0,	 35,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 3'015,	 3'375,	5,	26,	28 },
		{  27,	"Merciless",AE_PERCENT_DAMAGE,	0,	221,	240,	0,	0,	0,	0,	 40,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 3'616,	 4'000,	6,	29,	32 },
		{  28,	"Insane",	AE_PERCENT_DAMAGE,	0,	241,	260,	0,	0,	0,	0,	 45,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 4'267,	 4'675,	6,	33,	35 },
		{  29,	"Deadly",	AE_PERCENT_DAMAGE,	0,	261,	280,	0,	0,	0,	0,	 50,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 9'000,	 9'000,	7,	36,	38 },
		{  18,	"Ravaging",	AE_PERCENT_DAMAGE,	0,	281,	300,	0,	0,	0,	0,	 60,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	13'020,	13'500,	8,	39,	41 },
		{  18,	"Ravaging",	AE_PERCENT_DAMAGE,	0,	291,	300,	0,	0,	0,	0,	110,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	20'000,	20'000,	9,	58,	66 },
		...
		{  14,	"Brash",		AE_LOW_DUR_ADD_DAMAGE,	0,	25,	45,	0,	0,	0,	0,	19,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	   750,	 1'750,	 5,	15,	17 },
		{  15,	"Fragile",		AE_LOW_DUR_ADD_DAMAGE,	0,	65,	75,	0,	0,	0,	0,	32,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 3'250,	 3'750,	 8,	26,	31 },
		{  16,	"Brittle",		AE_LOW_DUR_ADD_DAMAGE,	0,	85,	90,	0,	0,	0,	0,	57,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 8'500,	 9'500,	11,	35,	37 },
		{  16,	"Crystalline",	AE_LOW_DUR_ADD_DAMAGE,	0,	90,	95,	0,	0,	0,	0,	97,	IA_RANGE | IA_STAFF | IA_MELEE | IA_FLASK | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	17'000,	19'000,	13,	61,	64 },
		...
		{ 47,	"Fighter's",	AE_TO_HIT_DAMAGE,	0,	 46,	 60,	0,	0,	11,	 15,	 14,	IA_RANGE | IA_STAFF | IA_MELEE | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	16,	0,	1,	 2'040,	 3'200,	 3,	  4,	  5 },
		{ 48,	"Squire's",		AE_TO_HIT_DAMAGE,	0,	 61,	 75,	0,	0,	16,	 20,	 21,	IA_RANGE | IA_MELEE | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,				IS_BATTLE,	16,	0,	1,	 3'300,	 4'750,	 4,	 11,	 13 },
		{ 49,	"Soldier's",	AE_TO_HIT_DAMAGE,	0,	 76,	 90,	0,	0,	21,	 25,	 28,	IA_RANGE | IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,							IS_BATTLE,	16,	0,	1,	 4'455,	 6'050,	 5,	 16,	 18 },
		{ 50,	"Warrior's",	AE_TO_HIT_DAMAGE,	0,	 91,	100,	0,	0,	26,	 30,	 34,	IA_RANGE | IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,							IS_BATTLE,	16,	0,	1,	 5'760,	 7'500,	 6,	 22,	 24 },
		{ 51,	"Champion's",	AE_TO_HIT_DAMAGE,	0,	101,	110,	0,	0,	31,	 35,	 41,	IA_RANGE | IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,							IS_BATTLE,	16,	0,	1,	 6'240,	 9'100,	 7,	 25,	 27 },
		{ 52,	"Knight's",		AE_TO_HIT_DAMAGE,	0,	111,	130,	0,	0,	36,	 40,	 49,	IA_RANGE | IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,							IS_BATTLE,	16,	0,	1,	 7'770,	10'850,	 8,	 28,	 31 },
		{ 53,	"Lord's",		AE_TO_HIT_DAMAGE,	0,	131,	140,	0,	0,	41,	 45,	 57,	IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,									IS_BATTLE,	16,	0,	1,	 8'325,	12'750,	 9,	 32,	 34 },
		{ 54,	"Baron's",		AE_TO_HIT_DAMAGE,	0,	141,	150,	0,	0,	46,	 50,	 66,	IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,									IS_BATTLE,	16,	0,	1,	10'080,	16'000,	10,	 39,	 42 },
		{ 54,	"Duke's",		AE_TO_HIT_DAMAGE,	0,	151,	155,	0,	0,	51,	 55,	 95,	IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,									IS_BATTLE,	16,	0,	1,	25'000,	25'000,	11,	 61,	 66 },
		{ 54,	"King's",		AE_TO_HIT_DAMAGE,	0,	151,	160,	0,	0,	61,	 75,	137,	IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,									IS_BATTLE,	16,	0,	1,	35'000,	35'000,	13,	 73,	 76 },
		{ 54,	"Emperor's",	AE_TO_HIT_DAMAGE,	0,	161,	170,	0,	0,	80,	100,	183,	IA_MELEE | IA_KNIFE | IA_MALLET | IA_PISTOL,									IS_BATTLE,	16,	0,	1,	60'000,	60'000,	25,	101,	114 },
		...
		{  13,	"Sentinel's",	AE_DFE,	0,	-14,	-15,	0,	0,	0,	0,	180,	IA_JEWEL,	IS_ALL,	16,	0,	1,	25'000,	25'000,	8,	99,	107 },
		//expand [wip	]
		...
		{  57,	"Sturdy",	AE_PERCENT_AC,	0,	25,	30,	0,	0,	0,	0,	33,	IA_HEAVY_ARMOR,	IS_BATTLE,	0,	0,	1,	2'500,	3'000,	10,	22,	25 },
		...
		{ 64,	"Ruby",				AE_RESIST,	ET_1_FIRE,	100,	120,	0,	0,	0,	0,	168,	IA_SHIELD | IA_ARMOR,						IS_ALL,	0,	0,	1,	50'000,	60'000,	9,	87,	91 },
		...
		{ 64,	"Sapphire",		AE_RESIST,	ET_2_LIGHTNING,	100,	120,	0,	0,	0,	0,	168,	IA_SHIELD | IA_ARMOR,						IS_ALL,	0,	0,	1,	50'000,	60'000,	9,	87,	91 },
		...
		{ 64,	"Amethyst",		AE_RESIST,	ET_3_ARCAN,	100,	120,	0,	0,	0,	0,	168,	IA_SHIELD | IA_ARMOR,						IS_ALL,	0,	0,	1,	50'000,	60'000,	9,	87,	91 },
		...
		{ 64,	"Emerald",		AE_RESIST,	ET_4_ACID,	100,	120,	0,	0,	0,	0,	168,	IA_SHIELD | IA_ARMOR,						IS_ALL,	0,	0,	1,	50'000,	60'000,	9,	87,	91 },
		...
		{ 64,	"Diamond",		AE_RESIST,	ET_6_COLD,	100,	120,	0,	0,	0,	0,	168,	IA_SHIELD | IA_ARMOR,						IS_ALL,	0,	0,	1,	50'000,	60'000,	9,	87,	91 },
		...
		{ 64,	"Labradorite",	AE_RESIST_All,	0,	31,	35,	0,	0,	0,	0,	182,	IA_BODY_ARMOR,								IS_ALL,	0,	0,	1,	93'000,	105'000,	14,	104,	118 },
		...
		{ 83,	"Hungry",		AE_LIFE_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	94,	IA_JEWEL,	IS_BATTLE,	0,	0,	1,	8'000,	8'000,	6,	52,	58 },*/
	...
	/*	{ 85,	"Vampiric",		AE_MANA_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	25,	IA_JEWEL,	IS_BATTLE,	0,	0,	1,	2'000,	2'000,	3,	14,	17 },
		...
		{ 85,	"Vampiric",		AE_MANA_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	94,	IA_JEWEL,	IS_BATTLE,	0,	0,	1,	8'000,	8'000,	6,	52,	58 },*/
	...
	{ 95,	"Apocalyptic",	AE_DAMAGE,	0,	96,	100,	0,	0,	0,	0,	171,	IA_JEWEL,	IS_BATTLE,	0,	0,	1,	19'200,	20'000,	15,	109,	116 },
	...
	{ 101,	"Armored",		AE_SPECIAL_AC,	0,	31,	35,	0,	0,	0,	0,	177,	IA_JEWEL,	IS_ALL,	0,	0,	1,	31'000,	35'000,	9,	93,	111 },
	...
	{ 121,	"Purifying",	AE_ELEM_HIT,	EA_MELEE_HOLY,	 2,	 3,	 9,	10,	0,	0,	 4,	IA_STAFF | IA_AXE | IA_MACE,	IS_BATTLE,	0,	0,	1,	   400,	   400,	1,	 0,	 0 },
	{ 122,	"Cleric's",		AE_ELEM_HIT,	EA_MELEE_HOLY,	 4,	 6,	18,	20,	0,	0,	10,	IA_STAFF | IA_AXE | IA_MACE,	IS_BATTLE,	0,	0,	1,	 1'000,	 1'000,	2,	 3,	 4 },
	{ 123,	"Priest's",		AE_ELEM_HIT,	EA_MELEE_HOLY,	 6,	 9,	27,	30,	0,	0,	24,	IA_STAFF | IA_AXE | IA_MACE,	IS_BATTLE,	0,	0,	1,	 2'500,	 2'500,	3,	15,	18 },
	{ 124,	"Purging",		AE_ELEM_HIT,	EA_MELEE_HOLY,	 9,	13,	35,	39,	0,	0,	55,	IA_STAFF | IA_AXE | IA_MACE,	IS_BATTLE,	0,	0,	1,	 5'000,	 5'000,	4,	30,	36 },
	{ 125,	"Sanctifying",	AE_ELEM_HIT,	EA_MELEE_HOLY,	24,	32,	64,	72,	0,	0,	62,	IA_STAFF | IA_AXE | IA_MACE_2H,	IS_BATTLE,	0,	0,	1,	 7'000,	 7'000,	6,	37,	39 },
	{ 125,	"Sanctifying",	AE_ELEM_HIT,	EA_MELEE_HOLY,	24,	32,	64,	72,	0,	0,	99,	IA_SWORD_1H | IA_MACE_1H,	IS_BATTLE,	0,	0,	1,	13'000,	13'000,	7,	55,	59 },*/

	{ 126,	"Voiding",		AE_ELEM_HIT,	EA_MELEE_ARCAN,	 1,	 1,	 2,	 3,	0,	0,	 4,	IA_STAFF | IA_MELEE | IA_CLAW,				IS_BATTLE,	0,	0,	1,	   400,	   400,	1,	 0,	 0 },
	{ 127,	"Depleting",	AE_ELEM_HIT,	EA_MELEE_ARCAN,	 2,	 3,	 9,	10,	0,	0,	10,	IA_STAFF | IA_MELEE | IA_CLAW,				IS_BATTLE,	0,	0,	1,	 1'000,	 1'000,	2,	 3,	 4 },
	{ 128,	"Exhausting",	AE_ELEM_HIT,	EA_MELEE_ARCAN,	 4,	 6,	18,	20,	0,	0,	24,	IA_STAFF | IA_MELEE | IA_CLAW,				IS_BATTLE,	0,	0,	1,	 2'500,	 2'500,	3,	15,	18 },
	{ 129,	"Devastating",	AE_ELEM_HIT,	EA_MELEE_ARCAN,	 6,	 9,	27,	30,	0,	0,	55,	IA_STAFF | IA_MELEE | IA_CLAW,				IS_BATTLE,	0,	0,	1,	 5'000,	 5'000,	4,	30,	36 },
	{ 130,	"Eldritch",		AE_ELEM_HIT,	EA_MELEE_ARCAN,	21,	27,	53,	61,	0,	0,	62,	IA_STAFF | IA_AXE | IA_SWORD_2H | IA_MACE_2H,	IS_BATTLE,	0,	0,	1,	 7'000,	 7'000,	6,	37,	39 },
	...
	{ 132,	"Toxic",			AE_ELEM_HIT,	EA_MELEE_ACID,	 2,	 3,	 7,	 8,	0,	0,	10,	IA_STAFF | IA_MELEE | IA_CLAW,						IS_BATTLE,	0,	0,	1,	 1'000,	 1'000,	2,	 3,	 4 },
	{ 133,	"Diluent",			AE_ELEM_HIT,	EA_MELEE_ACID,	 4,	 6,	15,	17,	0,	0,	24,	IA_STAFF | IA_MELEE | IA_CLAW,						IS_BATTLE,	0,	0,	1,	 2'500,	 2'500,	3,	15,	18 },
	{ 134,	"Corrodent",		AE_ELEM_HIT,	EA_MELEE_ACID,	 5,	 7,	23,	26,	0,	0,	55,	IA_STAFF | IA_MELEE | IA_CLAW,						IS_BATTLE,	0,	0,	1,	 5'000,	 5'000,	4,	30,	36 },
	{ 135,	"Disintegrating",	AE_ELEM_HIT,	EA_MELEE_ACID,	18,	24,	48,	56,	0,	0,	62,	IA_STAFF | IA_AXE | IA_SWORD_2H | IA_MACE_2H,	IS_BATTLE,	0,	0,	1,	 7'000,	 7'000,	6,	37,	39 },
	...
	//{ 141,	"Clarifying",		AE_XP_GAIN_PERCENT,	0,	14,	15,	0,	0,	0,	0,	70,	IA_JEWEL,	IS_ALL,	0,	0,	1,	22'000,	24'000,	5,	41,	46 },
	...
	//{ 142,	"Rapacious",	AE_GOLD_FIND,	0,	10,	20,	0,	0,	0,	0,	11,	IA_JEWEL | IA_ARMOR,	IS_ALL,	0,	0,	1,	   600,	 1'200,	2,	 2,	 3 },
	//{ 143,	"Covetous",		AE_GOLD_FIND,	0,	21,	25,	0,	0,	0,	0,	24,	IA_JEWEL | IA_ARMOR,	IS_ALL,	0,	0,	1,	 4'200,	 5'000,	3,	15,	18 },
	//{ 143,	"Covetous",		AE_GOLD_FIND,	0,	25,	30,	0,	0,	0,	0,	46,	IA_JEWEL | IA_ARMOR,	IS_ALL,	0,	0,	1,	10'000,	12'000,	4,	30,	35 },
	//{ 143,	"Covetous",		AE_GOLD_FIND,	0,	31,	35,	0,	0,	0,	0,	91,	IA_JEWEL,				IS_ALL,	0,	0,	1,	31'000,	35'000,	9,	50,	56 },
...
{ 146,	"Vindicative",	AE_ABSORB_MELEE_DAMAGE,	0,	 7,	 8,	0,	0,	0,	0,	 16,	IA_SHIELD | IA_ARMOR,			IS_ALL,		0,	0,	1,	 1'000,	 1'200,	 4,	  5,	  7 },
...
{ 147,	"Consuming",	AE_ABSORB_MELEE_DAMAGE,	0,	21,	25,	0,	0,	0,	0,	181,	IA_SHIELD,						IS_BATTLE,	0,	0,	1,	21'000,	25'000,	13,	109,	125 },
//helms
...
{ 147,	"Consuming",	AE_ABSORB_MELEE_DAMAGE,	0,	31,	35,	0,	0,	0,	0,	183,	IA_HELM,						IS_BATTLE,	0,	0,	1,	31'000,	35'000,	14,	108,	126 },
//boots/gloves/belt
...
{ 148,	"Devouring",	AE_ABSORB_MELEE_DAMAGE,	0,	23,	25,	0,	0,	0,	0,	180,	IA_BOOTS | IA_GLOVE | IA_BELT,	IS_BATTLE,	0,	0,	1,	23'000,	25'000,	13,	106,	109 },
{ 148,	"Devouring",	AE_ABSORB_MELEE_DAMAGE,	0,	26,	30,	0,	0,	0,	0,	182,	IA_BOOTS | IA_GLOVE | IA_BELT,	IS_BATTLE,	0,	0,	1,	26'000,	30'000,	15,	111,	129 },
//harness
...
{ 149,	"Devouring",	AE_ABSORB_MELEE_DAMAGE,	0,	46,	50,	0,	0,	0,	0,	185,	IA_BODY_ARMOR,					IS_BATTLE,	0,	0,	1,	46'000,	50'000,	14,	108,	113 },
{ 149,	"Devouring",	AE_ABSORB_MELEE_DAMAGE,	0,	51,	60,	0,	0,	0,	0,	184,	IA_BODY_ARMOR,					IS_BATTLE,	0,	0,	1,	51'000,	60'000,	14,	116,	130 },
...
{ 146,	"Vindicative",	AE_ABSORB_RANGED_DAMAGE,	0,	 7,	 8,	0,	0,	0,	0,	 16,	IA_SHIELD | IA_ARMOR,			IS_ALL,		0,	0,	1,	 1'000,	 1'200,	 4,	  5,	  7 },
...
{ 147,	"Consuming",	AE_ABSORB_RANGED_DAMAGE,	0,	21,	25,	0,	0,	0,	0,	181,	IA_SHIELD,						IS_BATTLE,	0,	0,	1,	21'000,	25'000,	13,	109,	122 },
//helms
...
{ 147,	"Consuming",	AE_ABSORB_RANGED_DAMAGE,	0,	31,	35,	0,	0,	0,	0,	183,	IA_HELM,						IS_BATTLE,	0,	0,	1,	31'000,	35'000,	14,	108,	124 },
//boots/gloves/belt
...
{ 148,	"Devouring",	AE_ABSORB_RANGED_DAMAGE,	0,	23,	25,	0,	0,	0,	0,	180,	IA_BOOTS | IA_GLOVE | IA_BELT,	IS_BATTLE,	0,	0,	1,	23'000,	25'000,	13,	106,	109 },
{ 148,	"Devouring",	AE_ABSORB_RANGED_DAMAGE,	0,	26,	30,	0,	0,	0,	0,	182,	IA_BOOTS | IA_GLOVE | IA_BELT,	IS_BATTLE,	0,	0,	1,	26'000,	30'000,	15,	111,	124 },
//harness
...
{ 149,	"Devouring",	AE_ABSORB_RANGED_DAMAGE,	0,	46,	50,	0,	0,	0,	0,	185,	IA_BODY_ARMOR,					IS_BATTLE,	0,	0,	1,	46'000,	50'000,	14,	108,	113 },
{ 149,	"Devouring",	AE_ABSORB_RANGED_DAMAGE,	0,	51,	60,	0,	0,	0,	0,	184,	IA_BODY_ARMOR,					IS_BATTLE,	0,	0,	1,	51'000,	60'000,	14,	116,	128 },
...
//could be used on uniques	{ 0,	"Summon AC",	AE_SUMMON_AC_PERCENT,	0,	5,	20,	0,	0,	0,	0,	25,	IA_ARMOR,	IS_ALL,	0,	0,	1,	100,	100,	5,	5+2 },
	...
	{ 189,	"Thorned",	AE_THORNS_PERCENT,	0,	101,	120,	0,	0,	0,	0,	 62,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,	IS_THORNS,	0,	0,	1,	11'100,	11'100,	 8,	 38,	 40 },
	{ 189,	"Thorned",	AE_THORNS_PERCENT,	0,	121,	140,	0,	0,	0,	0,	 98,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,	IS_THORNS,	0,	0,	1,	24'200,	28'000,	12,	 55,	 77 },
	{ 189,	"Thorned",	AE_THORNS_PERCENT,	0,	141,	150,	0,	0,	0,	0,	178,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,	IS_THORNS,	0,	0,	1,	56'400,	60'000,	16,	100,	115 },
	...
	// + damage series needs to be continued
		...
		//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
				...
				{ 203,	"Execution",	AE_DAMAGE,	0,	 181,	200,	0,	0,	0,	0,	182,	IA_STAFF | IA_SWORD_1H | IA_MACE_1H | IA_CLAW | IA_KNIFE | IA_MALLET,	IS_BATTLE,	0,	0,	1,	54'300,	60'000,	15,	101,	120 },
				//2H
				...
				{ 203,	"Execution",	AE_DAMAGE,	0,	361,	400,	0,	0,	0,	0,	182,	IA_RANGE | IA_AXE | IA_SWORD_2H | IA_MACE_2H | IA_PISTOL,							IS_BATTLE,	0,	0,	1,	54'300,	60'000,	15,	101,	120 },
...
{ 241,	"Protection",	AE_DFE,	0,	-19,	-20,	0,	0,	0,	0,	181,	IA_BELT | IA_BOOTS | IA_GLOVE,				IS_BATTLE,	0,	0,	1,	41'000,	47'000,	16,	 99,	115 },
{ 241,	"Protection",	AE_DFE,	0,	-21,	-25,	0,	0,	0,	0,	181,	IA_SHIELD,									IS_BATTLE,	0,	0,	1,	42'000,	50'000,	16,	105,	120 },
...
{ 241,	"Protection",	AE_DFE,	0,	-38,	-40,	0,	0,	0,	0,	179,	IA_BODY_ARMOR,	IS_BATTLE,	0,	0,	1,	38'000,	40'000,	15,	 95,	104 },
{ 241,	"Protection",	AE_DFE,	0,	-41,	-45,	0,	0,	0,	0,	183,	IA_BODY_ARMOR,	IS_BATTLE,	0,	0,	1,	56'000,	60'000,	16,	105,	120 },
...
{ 241,	"Protection",	AE_DFE,	0,	-28,	-30,	0,	0,	0,	0,	179,	IA_HELM,	IS_BATTLE,	0,	0,	1,	31'000,	33'000,	15,	 85,	 95 },
{ 241,	"Protection",	AE_DFE,	0,	-31,	-35,	0,	0,	0,	0,	182,	IA_HELM,	IS_BATTLE,	0,	0,	1,	41'000,	45'000,	16,	105,	120 },
...
{ 13,	"Deliverance",	AE_DFE,	0,	 -6,	 -6,	0,	0,	0,	0,	100,	IA_JEWEL,	IS_ALL,	1,	0,	1,	11'000,	11'000,	6,	48,	 52 },
{ 13,	"Refuge",		AE_DFE,	0,	 -7,	 -7,	0,	0,	0,	0,	120,	IA_JEWEL,	IS_ALL,	1,	0,	1,	14'000,	14'000,	6,	63,	 67 },
{ 13,	"Freedom",		AE_DFE,	0,	 -8,	 -8,	0,	0,	0,	0,	140,	IA_JEWEL,	IS_ALL,	1,	0,	1,	17'000,	17'000,	7,	78,	 82 },
{ 13,	"Sanctuary",	AE_DFE,	0,	 -9,	 -9,	0,	0,	0,	0,	160,	IA_JEWEL,	IS_ALL,	1,	0,	1,	21'000,	21'000,	7,	93,	 97 },
{ 13,	"Salvation",	AE_DFE,	0,	-10,	-10,	0,	0,	0,	0,	180,	IA_JEWEL,	IS_ALL,	1,	0,	1,	25'000,	25'000,	8,	99,	120 },
...
{ 285,	"Brute",		AE_STAT,	ST_STRENGTH,	56,	 60,	0,	0,	0,	0,	105,	IA_MELEE | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL | IA_JEWEL | IA_SHIELD | IA_ARMOR,	IS_BATTLE,	0,	0,	1,	35'500,	40'000,	 9,	57,	 67 },
{ 285,	"Might",		AE_STAT,	ST_STRENGTH,	61,	 70,	0,	0,	0,	0,	125,	IA_MELEE | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL | IA_JEWEL | IA_SHIELD | IA_ARMOR,	IS_BATTLE,	0,	0,	1,	40'500,	45'000,	10,	67,	 78 },
{ 285,	"Giants",		AE_STAT,	ST_STRENGTH,	71,	 80,	0,	0,	0,	0,	144,	IA_MELEE | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL | IA_JEWEL | IA_SHIELD | IA_ARMOR,	IS_BATTLE,	0,	0,	1,	45'500,	50'000,	11,	77,	 87 },
{ 285,	"Titans",		AE_STAT,	ST_STRENGTH,	81,	 90,	0,	0,	0,	0,	166,	IA_AXE | IA_SWORD_2H | IA_MACE_2H | IA_GLOVE,									IS_BATTLE,	0,	0,	1,	50'500,	55'000,	12,	87,	 97 },
...
{ 285,	"Mastery",		AE_STAT,	ST_DEXTERITY,	61,	 70,	0,	0,	0,	0,	127,	IA_RANGE | IA_PISTOL | IA_JEWEL | IA_ARMOR | IA_SHIELD,				IS_BATTLE,	0,	0,	1,	40'500,	45'000,	10,	67,	 77 },
{ 285,	"Perfection",	AE_STAT,	ST_DEXTERITY,	71,	 80,	0,	0,	0,	0,	146,	IA_RANGE | IA_JEWEL | IA_BODY_ARMOR | IA_BOOTS,						IS_BATTLE,	0,	0,	1,	45'500,	50'000,	11,	77,	 88 },
{ 285,	"Guile",		AE_STAT,	ST_DEXTERITY,	81,	 90,	0,	0,	0,	0,	168,	IA_RANGE | IA_BOOTS,												IS_BATTLE,	0,	0,	1,	50'500,	55'000,	12,	87,	 98 },
...
{ 285,	"Epiphany",		AE_STAT,	ST_MAGIC,	61,	 70,	0,	0,	0,	0,	125,	IA_JEWEL | IA_STAFF | IA_SHIELD | IA_HELM | IA_BODY_ARMOR | IA_GLOVE,	IS_MAGIC,	0,	0,	1,	40'500,	45'000,	10,	67,	 78 },
{ 285,	"Witchcraft",	AE_STAT,	ST_MAGIC,	71,	 80,	0,	0,	0,	0,	145,	IA_JEWEL | IA_STAFF | IA_SHIELD | IA_HELM,								IS_MAGIC,	0,	0,	1,	45'500,	50'000,	11,	77,	 87 },
{ 285,	"Sorcery",		AE_STAT,	ST_MAGIC,	81,	 90,	0,	0,	0,	0,	166,	IA_JEWEL | IA_STAFF | IA_SHIELD,										IS_MAGIC,	0,	0,	1,	50'500,	55'000,	12,	87,	 97 },
...
{ 285,	"Essence",		AE_STAT,	ST_VITALITY,	81,	 90,	0,	0,	0,	0,	167,	IA_BODY_ARMOR | IA_BELT,			IS_BATTLE,	0,	0,	1,	50'500,	55'000,	12,	87,	 97 },
...
{ 502,	"the Universe",		AE_ALL_STAT,	0,	26,	30,	0,	0,	0,	0,	183,	IA_AMULET,								IS_ALL,	0,	0,	1,	96'000,	100'000,	17,	99,	110 },
...
{ 297,	"Diabolism",	AE_SPELLS_LEVEL,	0,	6,	6,	0,	0,	0,	0,	147,	IA_JEWEL | IA_STAFF,						IS_MAGIC,	0,	0,	1,	45'000,	45'000,	14,	63,	 80 },
{ 297,	"Diabolism",	AE_SPELLS_LEVEL,	0,	7,	7,	0,	0,	0,	0,	184,	IA_JEWEL | IA_STAFF,						IS_MAGIC,	0,	0,	1,	55'000,	55'000,	15,	99,	119 },
...
{ 314,	"the Dragon",	AE_MANA,	0,	191,	200,	0,	0,	0,	0,	189,	IA_STAFF,										IS_MAGIC,	0,	0,	1,	19'100,	20'000,	13,	96,	106 },
...
{ 314,	"the Whale",	AE_HIT_POINTS,	0,	191,	200,	0,	0,	0,	0,	189,	IA_HEAVY_ARMOR,									IS_BATTLE,	0,	0,	1,	19'100,	20'000,	13,	96,	106 },
...
{ 339,	"Voiding",		AE_ELEM_HIT,	EA_ARROW_ARCAN,	 1,	 1,	 2,	 3,	0,	0,	 3,	IA_RANGE | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	   500,	   500,	2,	 0,	 0 },
{ 340,	"Depletion",	AE_ELEM_HIT,	EA_ARROW_ARCAN,	 2,	 3,	 5,	 6,	0,	0,	10,	IA_RANGE | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 1'000,	 1'000,	2,	 2,	 3 },
{ 341,	"Havoc",		AE_ELEM_HIT,	EA_ARROW_ARCAN,	 5,	 7,	 8,	12,	0,	0,	24,	IA_RANGE | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 2'000,	 2'000,	4,	 6,	 8 },
{ 342,	"Exhausting",	AE_ELEM_HIT,	EA_ARROW_ARCAN,	 9,	11,	12,	16,	0,	0,	40,	IA_RANGE | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 4'000,	 4'000,	6,	20,	24 },
{ 343,	"Devastation",	AE_ELEM_HIT,	EA_ARROW_ARCAN,	13,	15,	16,	20,	0,	0,	61,	IA_RANGE | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	 8'000,	 8'000,	8,	30,	33 },
{ 343,	"Devastation",	AE_ELEM_HIT,	EA_ARROW_ARCAN,	13,	15,	16,	20,	0,	0,	95,	IA_RANGE | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	11'000,	11'000,	8,	50,	58 },
...
//{ 356,	"the Bat",	AE_MANA_STEAL_1_2,	0,	3,	3,	0,	0,	0,	0,	8,	IA_JEWEL | IA_STAFF | IA_MELEE | IA_CLAW,	IS_BATTLE,	0,	0,	1,	1'500,	1'500,	2,	 3,	 4 },
//{ 357,	"Vampires",	AE_MANA_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	25,	IA_STAFF | IA_MELEE | IA_CLAW,			IS_BATTLE,	0,	0,	1,	2'000,	2'000,	3,	16,	20 },
//{ 357,	"Vampires",	AE_MANA_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	48,	IA_STAFF | IA_MELEE | IA_CLAW,		IS_BATTLE,	0,	0,	1,	4'000,	4'000,	4,	21,	30 },
//{ 357,	"Vampires",	AE_MANA_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	94,	IA_STAFF | IA_MELEE | IA_CLAW,		IS_BATTLE,	0,	0,	1,	9'000,	9'000,	5,	45,	56 },
//
//{ 358,	"The leech",AE_LIFE_STEAL_1_2,	0,	3,	3,	0,	0,	0,	0,	8,	IA_JEWEL | IA_STAFF | IA_MELEE | IA_CLAW,	IS_BATTLE,	0,	0,	1,	1'500,	1'500,	2,	 3,	 4 },
//{ 359,	"Blood",	AE_LIFE_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	25,	IA_STAFF | IA_MELEE | IA_CLAW,			IS_BATTLE,	0,	0,	1,	2'000,	2'000,	3,	16,	20 },
//{ 359,	"Blood",	AE_LIFE_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	48,	IA_STAFF | IA_MELEE | IA_CLAW,		IS_BATTLE,	0,	0,	1,	4'000,	4'000,	4,	21,	30 },
//{ 359,	"Blood",	AE_LIFE_STEAL_1_2,	0,	5,	5,	0,	0,	0,	0,	94,	IA_STAFF | IA_MELEE | IA_CLAW,		IS_BATTLE,	0,	0,	1,	9'000,	9'000,	5,	45,	56 },
...
{ 364,	"Velocity",	AE_ATTACK_SPEED,	0,	4,	4,	0,	0,	0,	0,	183,	IA_RANGE | IA_STAFF | IA_MELEE | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	75'000,	75'000,	25,	120,	130 },
...
{ 382,	"Imperviousness",	AE_AC,	0,	41,	50,	0,	0,	0,	0,	181,	IA_BODY_ARMOR,			IS_BATTLE,	0,	0,	1,	41'000,	50'000,	15,	100,	120 },
...
//{ 386,	"Abundance",	AE_GOLD_ABS_FIND,	0,	14,	16,	17,	20,	0,	0,	 22,	IA_JEWEL | IA_ARMOR | IA_FLASK,	IS_ALL,	0,	0,	1,	 2'300,	 4'000,	4,	11,	14 },
//{ 386,	"Abundance",	AE_GOLD_ABS_FIND,	0,	21,	25,	26,	30,	0,	0,	 40,	IA_JEWEL | IA_ARMOR | IA_FLASK,	IS_ALL,	0,	0,	1,	 8'400,	12'000,	4,	26,	30 },
...
//{ 386,	"Abundance",	AE_GOLD_ABS_FIND,	0,	51,	60,	71,	80,	0,	0,	174,	IA_JEWEL | IA_ARMOR | IA_FLASK,	IS_ALL,	0,	0,	1,	41'000,	50'000,	5,	76,	90 },
...
{ 392,	"Inflexibility",	AE_STUN_RESIST,	0,	17,	20,	0,	0,	0,	0,	178,	IA_MID_ARMOR | IA_HEAVY_ARMOR,												IS_BATTLE,	0,	0,	1,	34'000,	40'000,	15,	99,	113 },
...
//	{ 0,	"Add Element Damage",	AE_ELEMENT_DAMAGE,	0,	0,	0,	0,	0,	0,	0,	11,	IA_ALL,	IS_ALL,	0,	0,	1,	1000,	1000,	5,	5+2 },
	...
	{ 400,	"Teeth",	AE_ACTION,	EA_THORNS,	 27,	 38,	 48,	 56,	21,	 30,	 15,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,		IS_THORNS,	0,	0,	1,	 1'000,	 1'000,	 4,	 4,	 6 },
	{ 401,	"Barbs",	AE_ACTION,	EA_THORNS,	 17,	 18,	 19,	 20,	91,	100,	 26,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,		IS_THORNS,	0,	0,	1,	 2'500,	 2'500,	 5,	 9,	11 },
	{ 402,	"Thorns",	AE_ACTION,	EA_THORNS,	 33,	 36,	 40,	 45,	61,	 70,	 34,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,		IS_THORNS,	0,	0,	1,	 3'500,	 3'500,	 6,	13,	15 },
	{ 403,	"Spikes",	AE_ACTION,	EA_THORNS,	 60,	 70,	 85,	105,	41,	 55,	 42,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,		IS_THORNS,	0,	0,	1,	 6'500,	 6'500,	 7,	17,	19 },
	{ 404,	"Razors",	AE_ACTION,	EA_THORNS,	 62,	 72,	 80,	 85,	71,	 80,	 51,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,		IS_THORNS,	0,	0,	1,	11'500,	11'500,	 8,	21,	23 },
	{ 405,	"Lances",	AE_ACTION,	EA_THORNS,	515,	550,	650,	750,	11,	 15,	 59,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,		IS_THORNS,	0,	0,	1,	22'500,	22'500,	 9,	25,	28 },
	{ 406,	"Swords",	AE_ACTION,	EA_THORNS,	100,	110,	115,	145,	81,	 90,	 75,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,		IS_THORNS,	0,	0,	1,	32'500,	32'500,	10,	41,	44 },
	// add-on (needs rebalance)
	{ 406,	"Swords",	AE_ACTION,	EA_THORNS,	125,	135,	140,	170,	81,	 90,	 95,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,	IS_THORNS,	0,	0,	1,	44'500,	44'500,	11,	55,	60 },
	{ 406,	"Swords",	AE_ACTION,	EA_THORNS,	150,	165,	175,	200,	81,	 90,	115,	IA_BODY_ARMOR | IA_HELM | IA_SHIELD,	IS_THORNS,	0,	0,	1,	55'500,	55'500,	12,	74,	80 },
	...
	//	{ 0,	"Add Thorns",	AE_ACTION_VALUE,	EA_THORNS,	0,	0,	0,	0,	0,	0,	11,	IA_ALL,	IS_ALL,	0,	0,	1,	1000,	1000,	5,	5+2 },
		...
		{ 409,	"Dominus",		AE_CAST_SPEED,	0,	3,	3,	0,	0,	0,	0,	114,	IA_JEWEL | IA_STAFF,	IS_MAGIC,	0,	0,	0,	14'000,	14'000,	12,	56,	73 },
	...
	/*	{ 410,	"the Raven",	AE_LIFE_REGEN,	0,	 1,	 2,	0,	0,	0,	0,	  3,	IA_JEWEL | IA_SHIELD | IA_ARMOR,		IS_BATTLE,	0,	0,	1,	   300,	   600,	2,	 0,	 0 },
		...
		{ 414,	"the Eagle",	AE_LIFE_REGEN,	0,	16,	20,	0,	0,	0,	0,	121,	IA_JEWEL | IA_SHIELD | IA_ARMOR,	IS_BATTLE,	0,	0,	1,	16'000,	20'000,	8,	70,	80 },
		...
		{ 419,	"the Dragon",	AE_MANA_REGEN,	0,	16,	20,	0,	0,	0,	0,	121,	IA_JEWEL | IA_STAFF | IA_SHIELD | IA_ARMOR | IA_SWORD_1H,	IS_MAGIC,	0,	0,	1,	16'000,	20'000,	8,	70,	80 },
...
//	{ 0,	"ARD",	AE_ABSORB_RANGED_DAMAGE,	0,	0,	0,	0,	0,	0,	0,	11,	IA_ALL,	IS_ALL,	0,	0,	1,	1000,	1000,	5,	5+2 },
	...
	{ 433,	"Strengthening",	AE_SUMMON_DAMAGE,	0,	26,	27,	28,	30,	0,	0,	132,	IA_STAFF | IA_SHIELD | IA_SWORD_1H,	IS_SUMMONING,	0,	0,	1,	41'000,	45'000,	11,	66,	70 },
	...
	{ 439,	"Thickening",	AE_SUMMON_HP,	0,	270,	300,	0,	0,	0,	0,	132,	IA_BODY_ARMOR,	IS_SUMMONING,	0,	0,	1,	41'000,	45'000,	11,	66,	70 },
	...
	{ 444,	"Guarding",	AE_SUMMON_AC,	0,	31,	35,	0,	0,	0,	0,	132,	IA_ARMOR,	IS_SUMMONING,	0,	0,	1,	36'000,	40'000,	10,	66,	70 },
	...
	{ 449,	"Excellence",	AE_CRIT_CHANCE,	0,	0,	0,	0,	0,	13,	14,	128,	IA_RANGE | IA_STAFF | IA_MELEE | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	25'000,	25'000,	11,	70,	79 },
	{ 449,	"Preeminence",	AE_CRIT_CHANCE,	0,	0,	0,	0,	0,	15,	16,	176,	IA_RANGE | IA_STAFF | IA_AXE | IA_SWORD_2H | IA_MACE_2H | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	30'000,	32'000,	15,	80,	93 },
	...
	{ 452,	"Efficiency",	AE_CRIT_DAMAGE_PERCENT,	0,	151,	175,	0,	0,	0,	0,	124,	IA_RANGE | IA_STAFF | IA_MELEE | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	27'000,	27'000,	9,	75,	80 },
	...
	{ 455,	"Destruction",	AE_CRIT_PERCENT,	0,	76,	100,	0,	0,	8,	8,	102,	IA_RANGE | IA_STAFF | IA_MELEE | IA_TRAP | IA_CLAW | IA_KNIFE | IA_MALLET | IA_PISTOL,	IS_BATTLE,	0,	0,	1,	27'000,	27000,	9,	61,	65 },
	...
	//1h
		...
		{ 462,	"Obliteration",	AE_CRIT_DAMAGE,	0,	 700,	 800,	 900,	1000,	0,	0,	162,	IA_SWORD_1H | IA_MACE_1H,											IS_BATTLE,	0,	0,	1,	35'000,	35'000,	14,	84,	89 },
		//2h
			...
			{ 462,	"Obliteration",	AE_CRIT_DAMAGE,	0,	1000,	1200,	1300,	1500,	0,	0,	163,	IA_RANGE | IA_STAFF | IA_AXE | IA_SWORD_2H | IA_MACE_2H | IA_PISTOL,			IS_BATTLE,	0,	0,	1,	35'000,	35'000,	14,	85,	98 },
			...
			{ 465,	"Heroism",		AE_LIFE_PERCENT,	0,	21,	25,	0,	0,	0,	0,	181,	IA_MID_ARMOR | IA_HEAVY_ARMOR,	IS_BATTLE,	0,	0,	1,	21'000,	25'000,	12,	99,	119 },
			...
			{ 468,	"Afflatus",		AE_MANA_PERCENT,	0,	21,	25,	0,	0,	0,	0,	182,	IA_HELM,		IS_MAGIC,	0,	0,	1,	21'000,	25'000,	12,	99,	120 },
