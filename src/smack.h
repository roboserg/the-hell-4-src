...
RADEXPFUNC void RADEXPLINK SmackSoundCheck();
...
//======================================================================
  ...
  typedef void RADEXPLINK (*SmackTimerSetupType)();
  typedef u32 RADEXPLINK (*SmackTimerReadType)();
  typedef void RADEXPLINK (*SmackTimerDoneType)();
  ...
  #ifndef AIL_startup
    #ifdef __SW_3R
      extern s32 cdecl AIL_startup_reg();
      #define AIL_startup AIL_startup_reg
    #else
      extern s32 cdecl AIL_startup_stack();
  ...
  RADEXPFUNC void RADEXPLINK SmackSoundMSSLiteDone();
  ...
  #define SMACKINTERLACEBLIT       512
    ...
    RADEXPFUNC u32 RADEXPLINK SmackTimerRead();
